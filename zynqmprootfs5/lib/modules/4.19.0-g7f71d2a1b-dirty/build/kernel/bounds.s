...
// -D CONFIG_AS_LSE=1 -D KBUILD_BASENAME="bounds"
...
.LASF86:
	.string	"PG_reclaim"
.LASF107:
	.ascii	"GNU C89 9.3.0 -mlittle-endian -mgeneral-regs-only -mabi=lp64"
	...
	.ascii	"ull-pointer-checks -fstack-protector-strong -fno-o"
	.string	"mit-frame-pointer -fno-optimize-sibling-calls -fno-var-tracking-assignments -fno-strict-overflow -fno-merge-all-constants -fmerge-constants -fstack-check=no -fconserve-stack --param allow-store-data-races=0 -fstack-protector-strong -fstack-clash-protection"
.LASF106:
	.string	"lock_stat"
.LASF37:
...
.LASF92:
	.string	"PG_swapcache"
.LASF109:
	.string	"/lib/modules/4.19.0-g7f71d2a1b-dirty"
.LASF75:
	.string	"PG_active"
.LASF84:
	.string	"PG_head"
